...
// Temporariamente sem Lombok até configurar corretamente
...
public Wallet(final BanckService serviceType) {
    ...
    // Getter manual para walletType (já que Lombok não está funcionando ainda)
